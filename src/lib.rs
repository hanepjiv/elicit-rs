...
#![deny(absolute_paths_not_starting_with_crate, anonymous_parameters,
        ...
        unsafe_code, unused_extern_crates, unused_import_braces,
        unused_labels, unused_lifetimes, unused_qualifications,
        unused_results, variant_size_differences, dead_code, deprecated,
        ...
        safe_packed_borrows, stable_features, trivial_bounds,
        type_alias_bounds, tyvar_behind_raw_pointer, unconditional_recursion,
        unions_with_drop_fields, unknown_lints, unreachable_code,
        unreachable_patterns, unstable_name_collisions, unused_allocation,
        unused_assignments, unused_attributes, unused_comparisons,
        unused_doc_comments, unused_features, unused_imports, unused_macros,
        ...
        unknown_crate_types)]
#![warn(dead_code, unreachable_pub, renamed_and_removed_lints,
        unstable_features)]
#![allow(box_pointers, elided_lifetimes_in_paths, single_use_lifetimes,
